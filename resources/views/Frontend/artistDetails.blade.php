            ...
            <div class="container">
                <div class="row  m-b-50">
                    <div class="col-lg-12">
                        ...
                        <h1 class="text-center text-medium-light m-b-80">{{$artist->name}}</h1>

                    </div>
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-6"><img src='{{asset("dashboard/pictures/artist/$artist->image")}}' class="float-right img-fluid" alt="">
                                ...
                                <div class="text-center">
                                    ...
                                    <address>
                                        ...
                                        {{$artist->address}}<br>
                                        {{$artist->designation}}<br>
                                        <abbr title="Phone">P:</h4>{{$artist->contact}}
                                    </address>
...
<p class="lead text-center">Contact me</p>
        ...
        <!-- end: ABOUT AUTHOR -->
                ...
                <div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
                    <!-- Post item-->
                     @foreach($artist->artistDetails as $key => $data)
